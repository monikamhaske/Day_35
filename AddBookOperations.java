...
public class AddBookOperations {
    ...
    private static void retrieveByCityOrState(Connection connection) {
    ...
    private static void showByDate(Connection connection) {
    ...
    private static void editData(Connection connection) {
    ...
    private static void readFromDataBase(Connection connection) {
        String sql = "select personNAme.Firstname, personName.lastName,address.city,address.state,address.zip,address.pnone from personName Inner join address On personName.ID = address.personID";
